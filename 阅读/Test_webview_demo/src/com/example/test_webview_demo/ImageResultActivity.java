		...
		webView.getView().setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				...
				case WebView.HitTestResult.IMAGE_TYPE://获取点击的标签是否为图片
					...
					//ImageResultActivity.this.showDialog("����ͼƬ", path);
					final X5PopMenu popMenu=X5PopMenu.createInstance(ImageResultActivity.this.getApplicationContext());
					popMenu.createNewButton("保存图片", new View.OnClickListener() {
					...
					popMenu.createNewButton("取消", new View.OnClickListener() {
					...
					if(ImageResultActivity.this.hitPoint!=null){
						popMenu.showInParent(webView, hitPoint.x, hitPoint.y);
					}
					break;
				}
				return false;
