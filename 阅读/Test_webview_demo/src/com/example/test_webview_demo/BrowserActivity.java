...
import com.rescam.androidapp.bimx.activity.QRCodeActivity;
import com.rescam.androidapp.bimx.utils.location.CRequest;
...
public class BrowserActivity extends Activity {
	...
	private static final String mHomeUrl = "http://bimx.rescam.com/";
	private static final String TAG = "P-BIM钢结构施工软件3D";
	...
	private void init() {
		...
		mWebView.setWebViewClient(new WebViewClient() {
			...
			public boolean shouldOverrideUrlLoading(WebView view, String url) {
				...
				System.out.println("web拦截" + url);
				int result = url
						.indexOf("56bdd0e4-1c48-484f-9e30-3c9d6cb83be2");
				if (result >= 0) {
					...
					for (String strRequestKey : mapRequest.keySet()) {
						...
						compCode = strRequestValue;
					}

					Intent openCameraIntent = new Intent(
							getApplicationContext(), QRCodeActivity.class);
...
//				TbsLog.d(TAG, "url: " + arg0);
		...
		if (mIntentUrl == null) {
			...
			System.out.println(mHomeUrl+"11111111");
		} else {
			System.out.println(mHomeUrl+"22222222");
	...
	private void moreMenuClose() {
		if (mMenu != null && mMenu.getVisibility() == View.VISIBLE) {
			...
			mMore.setImageDrawable(getResources().getDrawable(
					R.drawable.theme_toolbar_btn_menu_fg_normal));
		}
	}
	...
	private void initBtnListenser() {
		...
		mTestProcesses.setVisibility(View.GONE);
		mTestWebviews.setVisibility(View.GONE);
		...
		mMore.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (mMenu.getVisibility() == View.GONE) {
					...
					mMore.setImageDrawable(getResources().getDrawable(
							R.drawable.theme_toolbar_btn_menu_fg_pressed));
				} else {
					mMenu.setVisibility(View.GONE);
					mMore.setImageDrawable(getResources().getDrawable(
							R.drawable.theme_toolbar_btn_menu_fg_normal));
			...
			public void onClick(View v) {
				...
				try {
					BrowserActivity.this.startActivityForResult(
							Intent.createChooser(intent, "choose file"), 1);
				} catch (android.content.ActivityNotFoundException ex) {
					Toast.makeText(BrowserActivity.this, "完成",
...
//					mWebView.loadUrl(testUrl);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case -1:
			...
			str = "http://bimx.rescam.com/page/show?url=oneCompleted&comp_code="
					+ compCode;
			System.out.println(str);
		...
		case 2:
			...
			// String str2=b2.getString("result");//str即为回传的值
			// System.out.println(str2);
			str = "http://bimx.rescam.com/page/show?url=manyCompleted&comp_code="
					+ compCode;
			mWebView.loadUrl(str);
			System.out.println(str);
			// two的返回数据
