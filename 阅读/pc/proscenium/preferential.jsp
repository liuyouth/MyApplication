...
<!--                <li class="active"><a href="/index/home" title="动态">动态</a></li>-->
                ...
                <li class="active"><a href="<%=basePath %>page_pageJump.html?pageName=preferential" title="优惠专享">优惠专享</a></li>
			...
			success : function(data){
				...
				if(goodsList != null && goodsList != ""){
					...
					for(var i=0;i<goodsList.length;i++){
						...
						li = '<li id="'+goodsData.goodsId+'" onclick="window.open(page_pageJump.html?pageName=preferential&goodsId='+goodsData.goodsId+')"><div class="voice-wp"><div class="voice-cover"><div class="voice-cover-wp">';
